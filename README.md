...
### `portman env [bash|fish|zsh]`

Prints shell code to set portman environment variables for the specified shell. portman uses this internally in the shell integration to automatically set the environment variables.
